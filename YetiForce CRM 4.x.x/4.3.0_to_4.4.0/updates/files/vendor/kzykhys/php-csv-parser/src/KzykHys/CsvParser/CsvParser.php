...
class CsvParser implements \IteratorAggregate
{
	 ...
	 * @return CsvParser
	 */
	public static function fromString($csv, array $option = [])
	{
		$lines = [];
	 ...
	 * @return CsvParser
	 */
	public static function fromArray(array $csv, array $option = [])
	{
	 ...
	 * @param array     $option
	 */
	public function __construct(\Iterator $csv, array $option = [])
	{
		$option = array_merge([
			'offset' => 0,
			'limit'  => -1
