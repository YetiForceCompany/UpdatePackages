...
class Connection extends Component
{
	...
	public function __sleep()
	{
		...
		unset($fields['pdo'], $fields["\000" . __CLASS__ . "\000" . '_master'], $fields["\000" . __CLASS__ . "\000" . '_slave'], $fields["\000" . __CLASS__ . "\000" . '_transaction'], $fields["\000" . __CLASS__ . "\000" . '_schema']);
