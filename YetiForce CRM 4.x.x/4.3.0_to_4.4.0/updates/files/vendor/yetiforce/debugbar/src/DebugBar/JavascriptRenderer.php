...
class JavascriptRenderer
{
	 ...
	 *
	 * @param bool $here              Set position of HTML. True if is to current position or false for end file
	 * @param bool $initialize        Whether to render the de bug bar initialization code
