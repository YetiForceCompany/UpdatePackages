...
return [
  'generalDesc' => [
	'NationalNumberPattern' => '(?:(?:[2579]\\d\\d|800)\\d|3550)\\d{4}',
	'PossibleLength' => [
	  0 => 8,
	],
  ...
  'fixedLine' => [
	'NationalNumberPattern' => '2(?:0(?:[169]\\d|3[1-4])|[1-357]\\d{2})\\d{4}',
  ...
  'mobile' => [
	'NationalNumberPattern' => '(?:7(?:210|[79]\\d{2})|9(?:2(?:1[01]|31)|69[67]|8(?:1[1-3]|89|97)|9\\d{2}))\\d{4}',
