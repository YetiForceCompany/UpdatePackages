...
class ShortNumberInfo
{
	 ...
	 * validity must first be checked using {@link #isValidShortNumber} or {@link * #isValidShortNumberForRegion}. Returns false if the number doesn't match the region provided.
	 *
	 * @param PhoneNumber $number            The valid short number to check
	 * @param string      $regionDialingFrom The region from which the number is dialed
	 *
	 ...
	 * lenient check than {@link #isValidShortNumber}. See {@link * #IsPossibleShortNumberForRegion(PhoneNumber, String)} for details.
	 *
