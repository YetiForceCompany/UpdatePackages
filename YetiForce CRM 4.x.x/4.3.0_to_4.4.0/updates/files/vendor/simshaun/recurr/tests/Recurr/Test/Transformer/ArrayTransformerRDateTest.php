...
class ArrayTransformerRDateTest extends ArrayTransformerBase
{
	...
	public function testRDateInConjunctionWithExDate()
	{
		...
		$this->assertSame(new \DateTime('2015-12-10'), $computed[0]->getStart());
		$this->assertSame(new \DateTime('2015-12-11'), $computed[1]->getStart());
		$this->assertSame(new \DateTime('2015-12-12'), $computed[2]->getStart());
	}
	...
	public function testRDateNoTime()
	{
		...
		$this->assertSame(new \DateTime('2015-12-10'), $computed[0]->getStart());
		$this->assertSame(new \DateTime('2015-12-11'), $computed[1]->getStart());
		$this->assertSame(new \DateTime('2015-12-08'), $computed[2]->getStart());
	}
	...
	public function testRDateWithTime()
	{
		...
		$this->assertCount(3, $computed);
		$this->assertSame(new \DateTime('2015-12-10 04:00:00'), $computed[0]->getStart());
		$this->assertSame(new \DateTime('2015-12-11 04:00:00'), $computed[1]->getStart());
		$this->assertSame(new \DateTime('2015-12-08 01:00:00'), $computed[2]->getStart());
	}
	...
	public function testRDateWithUtcTime()
	{
		...
		$this->assertCount(3, $computed);
		$this->assertSame(new \DateTime('2015-12-10 07:00:00'), $computed[0]->getStart());
		$this->assertSame(new \DateTime('2015-12-11 07:00:00'), $computed[1]->getStart());
		$this->assertSame(new \DateTime('2015-12-08 11:00:00Z'), $computed[2]->getStart());
	}
	...
	public function testRDateWithMixedTimezones()
	{
		...
		$this->assertSame(new \DateTime('2015-12-10 04:00:00'), $computed[0]->getStart());
		$this->assertSame(new \DateTime('2015-12-11 04:00:00'), $computed[1]->getStart());
		$this->assertSame(new \DateTime('2015-12-08 19:00:00'), $computed[2]->getStart());
		$this->assertSame(new \DateTime('2015-11-25 08:00:00Z'), $computed[3]->getStart());
	}
