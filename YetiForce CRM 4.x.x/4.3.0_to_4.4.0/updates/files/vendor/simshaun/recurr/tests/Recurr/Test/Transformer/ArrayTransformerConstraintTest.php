...
class ArrayTransformerConstraintTest extends ArrayTransformerBase
{
	...
	private function _testBefore($dateTimeClassName)
	{
		...
		$this->assertSame(new $dateTimeClassName('2014-03-16 04:00:00'), $computed[0]->getStart());
		$this->assertSame(new $dateTimeClassName('2014-04-16 04:00:00'), $computed[1]->getStart());
		...
		$this->assertSame(new $dateTimeClassName('2014-03-16 04:00:00'), $computed[0]->getStart());
		$this->assertSame(new $dateTimeClassName('2014-04-16 04:00:00'), $computed[1]->getStart());
		$this->assertSame(new $dateTimeClassName('2014-05-16 04:00:00'), $computed[2]->getStart());
	}
	...
	private function _testAfter($dateTimeClassName)
	{
		...
		$computed = $this->transformer->transform($rule, $constraint);
		$this->assertCount(2, $computed);
		$this->assertSame(new $dateTimeClassName('2014-06-16 04:00:00'), $computed[0]->getStart());
		$this->assertSame(new $dateTimeClassName('2014-07-16 04:00:00'), $computed[1]->getStart());
		...
		$this->assertSame(new $dateTimeClassName('2014-06-16 04:00:00'), $computed[0]->getStart());
		$this->assertSame(new $dateTimeClassName('2014-07-16 04:00:00'), $computed[1]->getStart());
		$this->assertSame(new $dateTimeClassName('2014-08-16 04:00:00'), $computed[2]->getStart());
		$this->assertSame(new $dateTimeClassName('2014-09-16 04:00:00'), $computed[3]->getStart());
		$this->assertSame(new $dateTimeClassName('2014-10-16 04:00:00'), $computed[4]->getStart());
		...
		$computed = $this->transformer->transform($rule, $constraint);
		$this->assertCount(3, $computed);
		$this->assertSame(new $dateTimeClassName('2014-05-16 04:00:00'), $computed[0]->getStart());
		$this->assertSame(new $dateTimeClassName('2014-06-16 04:00:00'), $computed[1]->getStart());
		$this->assertSame(new $dateTimeClassName('2014-07-16 04:00:00'), $computed[2]->getStart());
		...
		$this->assertSame(new $dateTimeClassName('2014-06-16 04:00:00'), $computed[1]->getStart());
		$this->assertSame(new $dateTimeClassName('2014-07-16 04:00:00'), $computed[2]->getStart());
		$this->assertSame(new $dateTimeClassName('2014-08-16 04:00:00'), $computed[3]->getStart());
		$this->assertSame(new $dateTimeClassName('2014-09-16 04:00:00'), $computed[4]->getStart());
	}
	...
	private function _testAfterFarFuture($dateTimeClassName)
	{
		...
		$computed   = $this->transformer->transform($rule, $constraint, false);
		$this->assertCount(5, $computed);
		$this->assertSame(new $dateTimeClassName('2020-06-16 04:00:00'), $computed[0]->getStart());
		$this->assertSame(new $dateTimeClassName('2020-07-16 04:00:00'), $computed[1]->getStart());
		$this->assertSame(new $dateTimeClassName('2020-08-16 04:00:00'), $computed[2]->getStart());
		$this->assertSame(new $dateTimeClassName('2020-09-16 04:00:00'), $computed[3]->getStart());
		$this->assertSame(new $dateTimeClassName('2020-10-16 04:00:00'), $computed[4]->getStart());
	}
	...
	private function _testBetween($dateTimeClassName)
	{
		...
		$computed   = $this->transformer->transform($rule, $constraint);
		$this->assertCount(3, $computed);
		$this->assertSame(new $dateTimeClassName('2014-04-16 04:00:00'), $computed[0]->getStart());
		$this->assertSame(new $dateTimeClassName('2014-05-16 04:00:00'), $computed[1]->getStart());
		$this->assertSame(new $dateTimeClassName('2014-06-16 04:00:00'), $computed[2]->getStart());
		...
		$this->assertSame(new $dateTimeClassName('2014-04-16 04:00:00'), $computed[1]->getStart());
		$this->assertSame(new $dateTimeClassName('2014-05-16 04:00:00'), $computed[2]->getStart());
		$this->assertSame(new $dateTimeClassName('2014-06-16 04:00:00'), $computed[3]->getStart());
		$this->assertSame(new $dateTimeClassName('2014-07-16 04:00:00'), $computed[4]->getStart());
	}
