...
class ArrayTransformerExDateTest extends ArrayTransformerBase
{
	...
	public function testExDateNoTime()
	{
		...
		$this->assertSame(new \DateTime('2014-06-01'), $computed[0]->getStart());
		$this->assertSame(new \DateTime('2014-06-03'), $computed[1]->getStart());
	}
	...
	public function testExDateWithTime()
	{
		...
		$this->assertCount(2, $computed);
		$this->assertSame(new \DateTime('2014-06-01 04:00:00'), $computed[0]->getStart());
		$this->assertSame(new \DateTime('2014-06-02 04:00:00'), $computed[1]->getStart());
	}
	...
	public function testExDateWithUtcTime()
	{
		...
		$this->assertCount(2, $computed);
		$this->assertSame(new \DateTime('2014-06-01 07:00:00'), $computed[0]->getStart());
		$this->assertSame(new \DateTime('2014-06-03 07:00:00'), $computed[1]->getStart());
	}
	...
	public function testExDateWithMixedTimezones()
	{
		...
		$this->assertSame(new \DateTime('2014-06-03 04:00:00'), $computed[0]->getStart());
	}
