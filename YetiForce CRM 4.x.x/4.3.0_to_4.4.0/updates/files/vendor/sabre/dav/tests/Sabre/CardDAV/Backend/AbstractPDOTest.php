...
abstract class AbstractPDOTest extends \PHPUnit_Framework_TestCase
{
	...
	public function testDeleteAddressBook()
	{
		...
		$this->assertSame([], $this->backend->getAddressBooksForUser('principals/user1'));
	}
	...
	public function testCreateCard()
	{
		...
		$this->assertSame('"' . md5('data2') . '"', $result);
		$result = $this->backend->getCard(1, 'card2');
		$this->assertSame(2, $result['id']);
		$this->assertSame('card2', $result['uri']);
		if (is_resource($result['carddata'])) {
			$result['carddata'] = stream_get_contents($result['carddata']);
		}
		$this->assertSame('data2', $result['carddata']);
	}
	...
	public function testUpdateCard()
	{
		...
		$this->assertSame('"' . md5('newdata') . '"', $result);
		...
		$this->assertSame('newdata', $result['carddata']);
	}
