...
class SubscriptionTest extends \PHPUnit_Framework_TestCase
{
	...
	public function getSub($override = [])
	{
		...
		$this->assertSame(1, count($subInfo));
	...
	public function testValues()
	{
		...
		$this->assertSame('uri', $sub->getName());
		$this->assertSame(date('2013-04-06 11:40:00'), $sub->getLastModified());
		$this->assertSame([], $sub->getChildren());
		...
		$this->assertSame('principals/user1', $sub->getOwner());
		...
		$this->assertSame($acl, $sub->getACL());
	...
	public function testValues2()
	{
		...
		$this->assertSame(null, $sub->getLastModified());
	}
	...
	public function testDelete()
	{
		...
		$this->assertSame([], $this->backend->getSubscriptionsForUser('principals1/user1'));
	}
