...
class HttpPutTest extends DAVServerTest
{
	...
	public function testPut()
	{
		...
		$this->assertSame(201, $response->getStatus(), 'Incorrect status code received. Full response body:' . $response->getBodyAsString());
	...
	public function testPutIntercept()
	{
		...
		$this->assertSame(418, $response->getStatus(), 'Incorrect status code received. Full response body: ' . $response->getBodyAsString());
