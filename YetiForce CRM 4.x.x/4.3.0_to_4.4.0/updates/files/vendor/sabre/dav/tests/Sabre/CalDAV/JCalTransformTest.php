...
class JCalTransformTest extends \Sabre\DAVServerTest
{
	...
	public function testGet()
	{
		...
		$this->assertSame(200, $response->getStatus(), 'Incorrect status code: ' . $body);
...
XML;
		...
		$this->assertSame(207, $response->getStatus(), 'Full rsponse: ' . $response->getBodyAsString());
...
XML;
		...
		$this->assertSame(207, $response->getStatus(), 'Invalid response code. Full body: ' . $response->getBodyAsString());
