...
class PluginTest extends \PHPUnit_Framework_TestCase
{
	...
	{
		$this->assertSame([], $this->plugin->getFeatures());
		$this->assertSame('notifications', $this->plugin->getPluginName());
		$this->assertSame(
			'notifications',
	...
	public function testPrincipalProperties()
	{
		...
		$this->assertSame('calendars/admin/notifications/', $prop->getHref());
	}
	...
	public function testNotificationGet()
	{
		...
		$this->assertSame(200, $httpResponse->status);
		$this->assertSame([
