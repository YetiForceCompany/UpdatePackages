...
class AddressBookTest extends \PHPUnit_Framework_TestCase
{
	...
	{
		$this->assertSame('book1', $this->ab->getName());
	}
	...
	public function testGetChild()
	{
		...
		$this->assertSame('card1', $card->getName());
	}
	...
	public function testGetChildren()
	{
		...
		$this->assertSame('card1', $cards[0]->getName());
		$this->assertSame('card2', $cards[1]->getName());
	}
	...
	public function testCreateFile()
	{
		...
		$this->assertSame('foo', $this->backend->cards['foo']['card2']);
	}

	public function testDelete()
	{
		$this->ab->delete();
		$this->assertSame(1, count($this->backend->addressBooks));
	}
	...
	public function testUpdateProperties()
	{
		...
		$this->assertSame('barrr', $this->backend->addressBooks[0]['{DAV:}displayname']);
	}
	...
	{
		$this->assertSame('principals/user1', $this->ab->getOwner());
	...
	public function testGetSyncToken()
	{
		...
		$this->assertSame(2, $ab->getSyncToken());
	}
