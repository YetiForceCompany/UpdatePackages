...
class AddressBookHomeTest extends \PHPUnit_Framework_TestCase
{
	...
	{
		$this->assertSame('user1', $this->s->getName());
	}
	...
	public function testGetChild()
	{
		...
		$this->assertSame('book1', $child->getName());
	}
	...
	public function testGetChildren()
	{
		...
		$this->assertSame('book1', $children[0]->getName());
	}
	...
	{
		$this->assertSame('principals/user1', $this->s->getOwner());
