...
<c:addressbook-query xmlns:d="DAV:" xmlns:c="urn:ietf:params:xml:ns:carddav">
    ...
    <c:filter>
		...
		$this->assertSame(207, $response->status, 'Incorrect status code. Full response body:' . $response->body);
...
<c:addressbook-query xmlns:d="DAV:" xmlns:c="urn:ietf:params:xml:ns:carddav">
    <d:prop>
      ...
      <d:getetag />
		...
		$this->assertSame(415, $response->status, 'Incorrect status code. Full response body:' . $response->body);
	}
