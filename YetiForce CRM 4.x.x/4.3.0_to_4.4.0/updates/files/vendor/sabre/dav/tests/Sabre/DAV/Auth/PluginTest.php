...
class PluginTest extends \PHPUnit_Framework_TestCase
{
	public function testInit()
	{
		...
		$this->assertSame($plugin, $fakeServer->getPlugin('auth'));
	...
	public function testAuthenticateFailDontAutoRequire()
	{
		...
		$this->assertSame(1, count($plugin->getLoginFailedReasons()));
	}
	...
	public function testMultipleBackend()
	{
		...
		$this->assertSame('principals/admin', $plugin->getCurrentPrincipal());
	}
