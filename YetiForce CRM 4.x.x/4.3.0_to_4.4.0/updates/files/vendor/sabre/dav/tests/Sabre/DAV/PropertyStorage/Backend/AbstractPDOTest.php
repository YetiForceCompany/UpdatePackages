...
abstract class AbstractPDOTest extends \PHPUnit_Framework_TestCase
{
	...
	public function testPropFind()
	{
		...
		$this->assertSame('Directory', $propFind->get('{DAV:}displayname'));
	}
	...
	public function testPropFindNothingToDo()
	{
		...
		$this->assertSame('foo', $propFind->get('{DAV:}displayname'));
	}
	...
	public function testPropPatchUpdate()
	{
		...
		$this->assertSame('bar', $propFind->get('{DAV:}displayname'));
	}
	...
	public function testPropPatchComplex()
	{
		...
		$this->assertSame($complex, $propFind->get('{DAV:}complex'));
	}
	...
	public function testPropPatchCustom()
	{
		...
		$this->assertSame($custom, $propFind->get('{DAV:}custom'));
	}
	...
	public function testPropPatchRemove()
	{
		...
		$this->assertSame(null, $propFind->get('{DAV:}displayname'));
	}
	...
	public function testMove()
	{
		...
		$this->assertSame('child', $propFind->get('{DAV:}displayname'));
	}
