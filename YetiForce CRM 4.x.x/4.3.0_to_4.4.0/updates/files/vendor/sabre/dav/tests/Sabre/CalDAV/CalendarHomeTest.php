...
class CalendarHomeTest extends \PHPUnit_Framework_TestCase
{
	...
	{
		$this->assertSame('user1', $this->usercalendars->getName());
	}
	...
	{
		$this->assertSame('principals/user1', $this->usercalendars->getOwner());
	}
	...
	public function testGetACL()
	{
		...
		$this->assertSame($expected, $this->usercalendars->getACL());
	}
