...
class ServerTest extends DAV\AbstractServer
{
	...
	public function testGet()
	{
		...
		$this->assertSame(200, $this->response->getStatus(), 'Invalid status code received.');
		$this->assertSame([
	...
	public function testPut()
	{
		...
		$this->assertSame('', $this->response->body);
		$this->assertSame('Testing new file', file_get_contents($filename));
	}
	...
	public function testPutAlreadyExists()
	{
		...
		$this->assertNotSame('Testing new file', file_get_contents($this->tempDir . '/test.txt'));
	}
	...
	public function testPutUpdate()
	{
		...
		$this->assertSame('', $this->response->body);
		$this->assertSame('Testing updated file', file_get_contents($this->tempDir . '/test.txt'));
	}
