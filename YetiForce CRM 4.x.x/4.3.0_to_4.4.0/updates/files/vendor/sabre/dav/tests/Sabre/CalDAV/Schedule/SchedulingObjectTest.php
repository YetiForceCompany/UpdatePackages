...
ICS;
	...
	public function testSetup()
	{
		...
		$this->assertSame('text/calendar; charset=utf-8', $children[0]->getContentType());
	}
	...
	public function testDelete()
	{
		...
		$this->assertSame(count($children) - 1, count($children2));
	}
	...
	public function testGetOwner()
	{
		...
		$obj = $children[0];
		$this->assertSame('principals/user1', $obj->getOwner());
	}
	...
	public function testGetACL()
	{
		...
		$obj = $children[0];
		$this->assertSame($expected, $obj->getACL());
	}
	...
	public function testDefaultACL()
	{
		...
		$this->assertSame($expected, $calendarObject->getACL());
	}
	...
	public function testGet()
	{
		...
		$this->assertSame($this->data, $obj->get());
	}
	...
	public function testGetEtag1()
	{
		...
		$this->assertSame('bar', $obj->getETag());
	}
	...
	public function testGetEtag2()
	{
		...
		$this->assertSame('"' . md5('foo') . '"', $obj->getETag());
	}
	...
	public function testGetContentType()
	{
		...
		$backend = new Backend\MockScheduling([], []);
		$obj = new SchedulingObject($backend, $objectInfo);
		$this->assertSame('text/calendar; charset=utf-8', $obj->getContentType());
	}
	...
	public function testGetContentType2()
	{
		...
		$backend = new Backend\MockScheduling([], []);
		$obj = new SchedulingObject($backend, $objectInfo);
		$this->assertSame('text/calendar; charset=utf-8; component=VEVENT', $obj->getContentType());
	}
