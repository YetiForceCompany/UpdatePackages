...
class CalendarTest extends \PHPUnit_Framework_TestCase
{
	...
	public function setup()
	{
		...
		$this->assertSame(2, count($this->calendars));
	...
	{
		$this->assertSame($this->calendars[0]['uri'], $this->calendar->getName());
	}
	...
	public function testUpdateProperties()
	{
		...
		$this->assertSame('NewName', $calendars2[0]['{DAV:}displayname']);
	}
	...
	public function testGetProperties()
	{
		...
		$this->assertSame(['VEVENT', 'VTODO'], $result['{urn:ietf:params:xml:ns:caldav}supported-calendar-component-set']->getValue());
	}
	...
	{
		$this->assertSame('principals/user1', $this->calendar->getOwner());
	}
	...
	public function testGetACL()
	{
		...
		$this->assertSame($expected, $this->calendar->getACL());
	}
