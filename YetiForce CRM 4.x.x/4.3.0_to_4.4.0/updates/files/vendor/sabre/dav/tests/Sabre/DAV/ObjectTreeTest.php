...
class ObjectTreeTest extends \PHPUnit_Framework_TestCase
{
	...
	public function testCopyFile()
	{
		...
		$this->assertSame('contents', file_get_contents(SABRE_TEMPDIR . '/root/file2.txt'));
	}
	...
	public function testCopyDirectory()
	{
		...
		$this->assertSame('subcontents', file_get_contents(SABRE_TEMPDIR . '/root/subdir2/subfile.txt'));
	}
	...
	public function testMoveFileNewParent()
	{
		...
		$this->assertFalse(file_exists(SABRE_TEMPDIR . '/root/file.txt'));
		$this->assertSame('contents', file_get_contents(SABRE_TEMPDIR . '/root/subdir/file2.txt'));
	}
