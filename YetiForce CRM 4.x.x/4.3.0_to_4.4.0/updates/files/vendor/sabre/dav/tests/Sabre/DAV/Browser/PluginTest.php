...
class PluginTest extends DAV\AbstractServer
{
	...
	public function testCollectionGet()
	{
		...
		$this->assertSame(200, $this->response->getStatus(), 'Incorrect status received. Full response body: ' . $this->response->getBodyAsString());
		$this->assertSame(
			[
	...
	public function testCollectionGetRoot()
	{
		...
		$this->assertSame(200, $this->response->status, 'Incorrect status received. Full response body: ' . $this->response->getBodyAsString());
		$this->assertSame(
			[
				'X-Sabre-Version'         => [DAV\Version::VERSION],
				'Content-Type'            => ['text/html; charset=utf-8'],
	...
	public function testGetAsset()
	{
		...
		$this->assertSame(200, $this->response->getStatus(), 'Error: ' . $this->response->body);
		$this->assertSame([
			'X-Sabre-Version'         => [DAV\Version::VERSION],
	...
	public function testGetAsset404()
	{
		...
		$this->assertSame(404, $this->response->getStatus(), 'Error: ' . $this->response->body);
	}
