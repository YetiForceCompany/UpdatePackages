...
class SharedCalendarTest extends \PHPUnit_Framework_TestCase
{
	...
	{
		$this->assertSame('principals/sharee', $this->getInstance()->getOwner());
	}
	...
	public function testGetACL()
	{
		...
		$this->assertSame($expected, $this->getInstance()->getACL());
	}
	...
	public function testGetChildACL()
	{
		...
		$this->assertSame($expected, $this->getInstance()->getChildACL());
	}
	...
	public function testUpdateInvites()
	{
		...
		$this->assertSame($expected, $instance->getInvites());
	}
