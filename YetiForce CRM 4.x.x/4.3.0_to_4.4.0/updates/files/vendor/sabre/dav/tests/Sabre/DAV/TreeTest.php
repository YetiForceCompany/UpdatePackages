...
class TreeTest extends \PHPUnit_Framework_TestCase
{
	...
	public function testCopy()
	{
		...
		$this->assertSame('foobar', $tree->getNodeForPath('hi/file')->get());
		$this->assertSame(['test1' => 'value'], $tree->getNodeForPath('hi/file')->getProperties([]));
	}
	...
	public function testMove()
	{
		...
		$this->assertSame('hi2', $tree->getNodeForPath('hi')->getName());
	...
	public function testGetChildren()
	{
		...
		$this->assertSame('hi', $children[0]->getName());
	}
	...
	public function testGetMultipleNodes()
	{
		...
		$this->assertSame('sub', $result['hi/sub']->getName());
		$this->assertSame('file', $result['hi/file']->getName());
	}
