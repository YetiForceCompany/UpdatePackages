...
class ServerPropsInfiniteDepthTest extends AbstractServer
{
	...
	public function testPropFindEmptyBody()
	{
		...
		$this->assertSame(207, $this->response->status, 'Incorrect status received. Full response body: ' . $this->response->getBodyAsString());
...
<d:propfind xmlns:d="DAV:">
  <d:prop>
    <d:supportedlock />
		...
		$this->assertSame(207, $this->response->getStatus(), $body);
...
<d:propfind xmlns:d="DAV:">
  <d:prop>
    <d:lockdiscovery />
		...
		$this->assertSame(8, count($data), 'We expected eight \'d:lockdiscovery\' tags');
	}
...
<d:propfind xmlns:d="DAV:">
  <d:prop>
    <d:macaroni />
		...
		$this->assertSame(8, count($val), $body);
