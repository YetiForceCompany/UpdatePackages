...
<d:principal-search-property-set xmlns:d="DAV:" />';
		...
		$this->assertSame(400, $server->httpResponse->status);
		$this->assertSame([
...
<d:principal-search-property-set xmlns:d="DAV:"><d:ohell /></d:principal-search-property-set>';
		...
		$this->assertSame(400, $server->httpResponse->status, $server->httpResponse->body);
		$this->assertSame([
			'X-Sabre-Version' => [DAV\Version::VERSION],
			'Content-Type'    => ['application/xml; charset=utf-8'],
		], $server->httpResponse->getHeaders());
...
<d:principal-search-property-set xmlns:d="DAV:"/>';
		...
		$this->assertSame(200, $server->httpResponse->status, $server->httpResponse->body);
		$this->assertSame([
			'X-Sabre-Version' => [DAV\Version::VERSION],
			'Content-Type'    => ['application/xml; charset=utf-8'],
		], $server->httpResponse->getHeaders());
