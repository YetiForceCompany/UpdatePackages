...
class ServerMKCOLTest extends AbstractServer
{
	...
	public function testMKCOLBrokenXML()
	{
		...
		$this->assertSame(400, $this->response->getStatus(), $this->response->getBodyAsString());
	}
...
<mkcol xmlns="DAV:">
  <set>
    <prop>
		...
		$this->assertSame(400, $this->response->status, 'Wrong statuscode received. Full response body: ' . $this->response->body);
	}
...
<mkcol xmlns="DAV:">
  <set>
    <prop>
		...
		$this->assertSame(403, $this->response->status, 'Wrong statuscode received. Full response body: ' . $this->response->body);
	}
...
<mkcol xmlns="DAV:">
  <set>
    <prop>
		...
		$this->assertSame(201, $this->response->status, 'Wrong statuscode received. Full response body: ' . $this->response->body);
	}
...
<mkcol xmlns="DAV:">
  <set>
	...
	public function testMKCOLNoParent()
	{
		...
		$this->assertSame(409, $this->response->status, 'Wrong statuscode received. Full response body: ' . $this->response->body);
	}
	...
	public function testMKCOLAlreadyExists()
	{
		...
		$this->assertSame(405, $this->response->status, 'Wrong statuscode received. Full response body: ' . $this->response->body);
	}
...
<mkcol xmlns="DAV:">
  <set>
    <prop>
		...
		$this->assertSame(207, $this->response->status, 'Wrong statuscode received. Full response body: ' . $this->response->body);
