...
class ServerRangeTest extends \Sabre\DAVServerTest
{
	...
	public function testRange()
	{
		...
		$this->assertSame('st c', $response->getBodyAsString());
	}
	...
	public function testStartRange()
	{
		...
		$this->assertSame(206, $response->getStatus());
		$this->assertSame('st contents', $response->getBodyAsString());
	}
	...
	public function testEndRange()
	{
		...
		$this->assertSame(206, $response->getStatus());
		$this->assertSame('contents', $response->getBodyAsString());
	}
	...
	public function testNonSeekableStream()
	{
		...
		$this->assertSame(206, $response->getStatus(), $response);
		$this->assertSame([
			'X-Sabre-Version' => [Version::VERSION],
			'Content-Type'    => ['application/octet-stream'],
			'Content-Length'  => [4],
	...
	public function testIfRangeEtagIncorrect()
	{
		...
		$this->assertSame('Test contents', $response->getBodyAsString());
	}
