...
class ClientTest extends \PHPUnit_Framework_TestCase
{
	public function testCreateCurlSettingsArrayGET()
	{
		...
		$this->assertSame($settings, $client->createCurlSettingsArray($request));
	}
	...
	public function testParseCurlResult()
	{
		...
		$this->assertSame(Client::STATUS_SUCCESS, $result['status']);
		$this->assertSame(200, $result['http_code']);
		$this->assertSame(200, $result['response']->getStatus());
		$this->assertSame(['Header1' => ['Val1']], $result['response']->getHeaders());
		$this->assertSame('Foo', $result['response']->getBodyAsString());
	}
	...
	public function testParseCurlError()
	{
		...
		$this->assertSame(Client::STATUS_CURLERROR, $result['status']);
		$this->assertSame(1, $result['curl_errno']);
		$this->assertSame('Curl error', $result['curl_errmsg']);
	}
	...
	public function testDoRequestCurlError()
	{
		...
		try {
			...
			$this->assertSame('Curl error', $e->getMessage());
		}
	}
}
