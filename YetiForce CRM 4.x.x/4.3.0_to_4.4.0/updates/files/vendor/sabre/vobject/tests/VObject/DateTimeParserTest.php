...
class DateTimeParserTest extends TestCase
{
	...
	{
		$this->assertSame('+1 weeks', DateTimeParser::parseDuration('P1W', true));
		$this->assertSame('+5 days', DateTimeParser::parseDuration('P5D', true));
		$this->assertSame('+5 days 3 hours 50 minutes 12 seconds', DateTimeParser::parseDuration('P5DT3H50M12S', true));
		$this->assertSame('-1 weeks 50 minutes', DateTimeParser::parseDuration('-P1WT50M', true));
		$this->assertSame('+50 days 3 hours 2 seconds', DateTimeParser::parseDuration('+P50DT3H2S', true));
		$this->assertSame('+0 seconds', DateTimeParser::parseDuration('+PT0S', true));
		$this->assertSame(new DateInterval('PT0S'), DateTimeParser::parseDuration('PT0S'));
	}

	public function testParseICalendarDurationDateInterval()
	{
		$expected = new DateInterval('P7D');
		$this->assertSame($expected, DateTimeParser::parseDuration('P1W'));
		$this->assertSame($expected, DateTimeParser::parse('P1W'));

		$expected = new DateInterval('PT3M');
		$expected->invert = true;
		$this->assertSame($expected, DateTimeParser::parseDuration('-PT3M'));
	}
	...
	public function testParseICalendarDateTime()
	{
		...
		$this->assertSame($compare, $dateTime);
	}
