...
class DateAndOrTimeTest extends TestCase
{
	 ...
	 * @dataProvider dates
	 */
	public function testGetJsonValue($input, $output)
	{
		$vcard = new VObject\Component\VCard();
		$prop = $vcard->createProperty('BDAY', $input);

		$this->assertSame([$output], $prop->getJsonValue());
	}
	...
	public function testSetParts()
	{
		...
		$this->assertSame('20140402T183700Z', $prop->getValue());
	}

	public function testSetPartsDateTimeImmutable()
	{
		$vcard = new VObject\Component\VCard();
	...
	public function testSetValueDateTimeImmutable()
	{
		$vcard = new VObject\Component\VCard();
	...
	public function testSetDateTimeOffset()
	{
		...
		$this->assertSame('20140402T183700-0400', $prop->getValue());
	}
	...
	public function testGetDateTime()
	{
		...
		$dt = $prop->getDateTime();
		$this->assertSame('2014-04-02T18:37:00-04:00', $dt->format('c'), 'For some reason this one failed. Current default timezone is: ' . date_default_timezone_get());
	}
	...
	public function testGetDate()
	{
		...
		$this->assertSame('DATE', $prop->getValueType());
		$this->assertSame('BDAY:20140402', rtrim($prop->serialize()));
	}
	...
	public function testGetDateIncomplete()
	{
		...
		$this->assertSame($year . '0407', $dt->format('Ymd'));
	}
