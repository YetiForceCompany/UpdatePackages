...
class RecurTest extends TestCase
{
	...
	public function testParts()
	{
		...
		$this->assertSame(['FREQ' => 'DAILY'], $recur->getParts());
		$recur->setParts(['freq' => 'MONTHLY']);

		$this->assertSame(['FREQ' => 'MONTHLY'], $recur->getParts());
	}
	...
	public function testSetValueWithCount()
	{
		...
		$this->assertSame($recur->getParts()['COUNT'], 3);
	}
...
';
		...
		$this->assertSame('2016-03-05T23:00:00Z', $untilJsonString);
	}
...
';
	...
	public function testValidateInvalidByMonthRruleWithRepair()
	{
		...
		$this->assertSame('BYMONTH in RRULE must have value(s) between 1 and 12!', $result[0]['message']);
		$this->assertSame(1, $result[0]['level']);
		$this->assertSame('FREQ=YEARLY;COUNT=6;BYMONTHDAY=24', $property->getValue());
	}
	...
	public function testValidateInvalidByMonthRruleWithoutRepair()
	{
		...
		$this->assertSame('FREQ=YEARLY;COUNT=6;BYMONTHDAY=24;BYMONTH=0', $property->getValue());
	}
	...
	public function testValidateInvalidByMonthRruleWithoutRepair2()
	{
		...
		$this->assertSame('FREQ=YEARLY;COUNT=6;BYMONTHDAY=24;BYMONTH=BLA', $property->getValue());
	}
	...
	public function testValidateInvalidByMonthRruleMultipleWithRepair()
	{
		...
		$this->assertSame('BYMONTH in RRULE must have value(s) between 1 and 12!', $result[0]['message']);
		$this->assertSame(1, $result[0]['level']);
		$this->assertSame('BYMONTH in RRULE must have value(s) between 1 and 12!', $result[1]['message']);
		$this->assertSame(1, $result[1]['level']);
		$this->assertSame('FREQ=YEARLY;COUNT=6;BYMONTHDAY=24;BYMONTH=1,2,3,4', $property->getValue());
	}
	...
	public function testValidateOneOfManyInvalidByMonthRruleWithRepair()
	{
		...
		$this->assertSame('BYMONTH in RRULE must have value(s) between 1 and 12!', $result[1]['message']);
		$this->assertSame(1, $result[1]['level']);
		$this->assertSame('FREQ=YEARLY;COUNT=6;BYMONTHDAY=24;BYMONTH=3', $property->getValue());
	}
	...
	public function testValidateValidByMonthRrule()
	{
		...
		$this->assertSame('FREQ=YEARLY;COUNT=6;BYMONTHDAY=24;BYMONTH=2,3', $property->getValue());
	}
	...
	public function testValidateRruleBySecondZero()
	{
		...
		$this->assertSame('FREQ=DAILY;BYHOUR=10;BYMINUTE=30;BYSECOND=0;UNTIL=20150616T153000Z', $property->getValue());
	}
	...
	public function testValidateValidByWeekNoWithRepair()
	{
		...
		$this->assertSame('FREQ=YEARLY;COUNT=6;BYWEEKNO=11', $property->getValue());
	}
	...
	public function testValidateInvalidByWeekNoWithRepair()
	{
		...
		$this->assertCount(1, $result);
		$this->assertSame('BYWEEKNO in RRULE must have value(s) from -53 to -1, or 1 to 53!', $result[0]['message']);
		$this->assertSame(1, $result[0]['level']);
		$this->assertSame('FREQ=YEARLY;COUNT=6;BYDAY=WE', $property->getValue());
	}
	...
	public function testValidateMultipleInvalidByWeekNoWithRepair()
	{
		...
		$this->assertSame('BYWEEKNO in RRULE must have value(s) from -53 to -1, or 1 to 53!', $result[0]['message']);
		$this->assertSame(1, $result[0]['level']);
		$this->assertSame('BYWEEKNO in RRULE must have value(s) from -53 to -1, or 1 to 53!', $result[1]['message']);
		$this->assertSame(1, $result[1]['level']);
		$this->assertSame('FREQ=YEARLY;COUNT=6;BYWEEKNO=2;BYDAY=WE', $property->getValue());
	}
	...
	public function testValidateInvalidByWeekNoWithoutRepair()
	{
		...
		$this->assertSame('BYWEEKNO in RRULE must have value(s) from -53 to -1, or 1 to 53!', $result[0]['message']);
		$this->assertSame(3, $result[0]['level']);
		$this->assertSame('FREQ=YEARLY;COUNT=6;BYWEEKNO=55;BYDAY=WE', $property->getValue());
	}
	...
	public function testValidateValidByYearDayWithRepair()
	{
		...
		$this->assertCount(0, $result);
		$this->assertSame('FREQ=YEARLY;COUNT=6;BYYEARDAY=119', $property->getValue());
	}
	...
	public function testValidateInvalidByYearDayWithRepair()
	{
		...
		$this->assertCount(1, $result);
		$this->assertSame('BYYEARDAY in RRULE must have value(s) from -366 to -1, or 1 to 366!', $result[0]['message']);
		$this->assertSame(1, $result[0]['level']);
		$this->assertSame('FREQ=YEARLY;COUNT=6;BYDAY=WE', $property->getValue());
	}
	...
	public function testValidateMultipleInvalidByYearDayWithRepair()
	{
		...
		$this->assertSame('BYYEARDAY in RRULE must have value(s) from -366 to -1, or 1 to 366!', $result[0]['message']);
		$this->assertSame(1, $result[0]['level']);
		$this->assertSame('BYYEARDAY in RRULE must have value(s) from -366 to -1, or 1 to 366!', $result[1]['message']);
		$this->assertSame(1, $result[1]['level']);
		$this->assertSame('FREQ=YEARLY;COUNT=6;BYYEARDAY=2;BYDAY=WE', $property->getValue());
	}
	...
	public function testValidateInvalidByYearDayWithoutRepair()
	{
		...
		$this->assertSame('BYYEARDAY in RRULE must have value(s) from -366 to -1, or 1 to 366!', $result[0]['message']);
		$this->assertSame(3, $result[0]['level']);
		$this->assertSame('FREQ=YEARLY;COUNT=6;BYYEARDAY=380;BYDAY=WE', $property->getValue());
	}
}
