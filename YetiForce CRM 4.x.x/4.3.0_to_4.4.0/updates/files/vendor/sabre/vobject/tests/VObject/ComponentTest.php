...
class ComponentTest extends TestCase
{
	...
	public function testMagicGet()
	{
		...
		$this->assertSame('VEVENT', $event->name);
	...
	public function testMagicGetGroups()
	{
		...
		$this->assertSame('EMAIL', $email1[0]->name);
		$this->assertSame('GROUP1', $email1[0]->group);

		$email3 = $comp->{'.email'};
		$this->assertSame('EMAIL', $email3[0]->name);
		$this->assertSame(null, $email3[0]->group);
	}
	...
	public function testMagicSetScalar()
	{
		...
		$this->assertSame('myValue', (string) $comp->MYPROP);
	}
	...
	public function testMagicSetScalarTwice()
	{
		...
		$this->assertSame(1, count($comp->children()));
		$this->assertInstanceOf('Sabre\\VObject\\Property', $comp->MYPROP);
		$this->assertSame('myValue', (string) $comp->MYPROP);
	}
	...
	public function testMagicSetArray()
	{
		...
		$this->assertSame(['Acme Inc', 'Section 9'], $comp->ORG->getParts());
	}
	...
	public function testMagicSetComponent()
	{
		...
		$this->assertSame(1, count($comp));

		$this->assertSame('VEVENT', $comp->VEVENT->name);
	}
	...
	public function testArrayAccessGet()
	{
		...
		$this->assertSame(2, count($comp->children()));
		$this->assertTrue($comp->vevent[1] instanceof Component);
		$this->assertSame('Event 2', (string) $comp->vevent[1]->summary);
	}
	...
	public function testAddScalar()
	{
		...
		$this->assertSame('MYPROP', $bla->name);
		$this->assertSame('value', (string) $bla);
	}
	...
	public function testAddScalarParams()
	{
		...
		$this->assertSame(1, count($bla->parameters()));

		$this->assertSame('PARAM1', $bla->parameters['PARAM1']->name);
		$this->assertSame('value1', $bla->parameters['PARAM1']->getValue());
	}
	...
	public function testMagicUnset()
	{
		...
		$this->assertSame(0, count($comp->children()));
	}

	public function testCount()
	{
		$comp = new VCalendar();
		$this->assertSame(1, $comp->count());
	}
	...
	public function testGetComponents()
	{
		...
		$this->assertSame('VTODO', $r[0]->name);
	}
	...
	public function testInstantiateWithChildren()
	{
		...
		$this->assertSame(['Acme Inc.', 'Section 9'], $comp->ORG->getParts());
		$this->assertSame('Finn The Human', $comp->FN->getValue());
	}
	...
	public function testInstantiateSubComponent()
	{
		...
		$this->assertSame('12345', $comp->VEVENT->UID->getValue());
	}
	...
	public function testValidateRules($componentList, $errorCount)
	{
		...
		$this->assertSame($errorCount, count($component->validate()));
	}
	...
	public function testValidateRepair()
	{
		...
		$this->assertSame('yow', $component->BAR->getValue());
	}
	...
	public function testValidateRepairShouldNotDeduplicatePropertiesWhenValuesDiffer()
	{
		...
		$this->assertSame(3, $messages[0]['level']);
		$this->assertSame(2, count($component->GIR));
	}
	...
	public function testValidateRepairShouldDeduplicatePropertiesWhenValuesAndParametersAreEqual()
	{
		...
		$this->assertSame(1, count($messages));
		$this->assertSame(1, $messages[0]['level']);
		$this->assertSame(1, count($component->GIR));
	}
