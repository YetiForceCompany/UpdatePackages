...
class DocumentTest extends TestCase
{
	public function testGetDocumentType()
	{
		...
		$this->assertSame(Document::UNKNOWN, $doc->getDocumentType());
	}

	public function testConstruct()
	{
		$doc = new MockDocument('VLIST');
		$this->assertSame('VLIST', $doc->name);
	}
	...
	{
		$vcal = new Component\VCalendar([], false);
		$this->assertSame('Sabre\\VObject\\Property\\Text', $vcal->getClassNameForPropertyValue('TEXT'));
	...
	public function testDestroy()
	{
		...
		$this->assertSame($event, $prop->parent);
