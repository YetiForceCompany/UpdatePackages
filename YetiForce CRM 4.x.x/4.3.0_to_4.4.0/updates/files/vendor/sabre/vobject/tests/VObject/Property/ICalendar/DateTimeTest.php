...
class DateTimeTest extends TestCase
{
	...
	public function testSetDateTime()
	{
		...
		$this->assertSame('19850704T013000', (string) $elem);
		$this->assertSame('Europe/Amsterdam', (string) $elem['TZID']);
	...
	public function testSetDateTimeUTC()
	{
		...
		$this->assertSame('19850704T013000Z', (string) $elem);
		$this->assertNull($elem['TZID']);
	...
	public function testSetDateTimeDATE()
	{
		...
		$this->assertSame('19850704', (string) $elem);
		$this->assertNull($elem['TZID']);
		$this->assertSame('DATE', (string) $elem['VALUE']);
	...
	public function testSetValueArray()
	{
		...
		$this->assertSame('19850704T013000,19850704T023000', (string) $elem);
		$this->assertSame('Europe/Amsterdam', (string) $elem['TZID']);
		$this->assertNull($elem['VALUE']);
	...
	public function testSetPartsStrings()
	{
		...
		$this->assertSame('19850704T013000Z,19850704T023000Z', (string) $elem);
		$this->assertNull($elem['VALUE']);
	...
	public function testGetDateTimeCached()
	{
		...
		$this->assertSame($elem->getDateTime(), $dt);
	}
	...
	public function testGetDateTimeDateDATE()
	{
		...
		$this->assertSame('1985-07-04 00:00:00', $dt->format('Y-m-d H:i:s'));
	}
	...
	public function testGetDateTimeDateDATEReferenceTimeZone()
	{
		...
		$this->assertInstanceOf('DateTimeImmutable', $dt);
		$this->assertSame('1985-07-04 04:00:00', $dt->format('Y-m-d H:i:s'));
	}
	...
	public function testGetDateTimeDateFloating()
	{
		...
		$this->assertInstanceOf('DateTimeImmutable', $dt);
		$this->assertSame('1985-07-04 01:30:00', $dt->format('Y-m-d H:i:s'));
	}
	...
	public function testGetDateTimeDateFloatingReferenceTimeZone()
	{
		...
		$this->assertSame('1985-07-04 05:30:00', $dt->format('Y-m-d H:i:s'));
	}
	...
	public function testGetDateTimeDateLOCALTZ()
	{
		...
		$this->assertInstanceOf('DateTimeImmutable', $dt);
		$this->assertSame('1985-07-04 01:30:00', $dt->format('Y-m-d H:i:s'));
		$this->assertSame('Europe/Amsterdam', $dt->getTimeZone()->getName());
	}
	...
	public function testGetDateTimeBadTimeZone()
	{
		...
		$this->assertInstanceOf('DateTimeImmutable', $dt);
		$this->assertSame('1985-07-04 01:30:00', $dt->format('Y-m-d H:i:s'));
		$this->assertSame('Canada/Eastern', $dt->getTimeZone()->getName());
	...
	public function testUpdateValueParameter()
	{
		...
		$this->assertSame("DTSTART;VALUE=DATE:20130607\r\n", $dtStart->serialize());
	}
	...
	public function testCreateDatePropertyThroughAdd()
	{
		...
		$this->assertSame("DTSTART;VALUE=DATE:20140307\r\n", $dtstart->serialize());
	}
}
