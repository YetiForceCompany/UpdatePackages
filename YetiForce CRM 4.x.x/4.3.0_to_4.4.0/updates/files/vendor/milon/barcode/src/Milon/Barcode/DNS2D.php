...
class DNS2D
{
	 ...
	 * @protected
	 */
	protected function getBarcodePNG($code, $type, $w = 3, $h = 3, $color = [0, 0, 0])
	{
		if (!$this->store_path) {
			$this->setStorPath(app('config')->get('barcode.store_path'));
		}
	 ...
	 * @protected
	 */
	protected function getBarcodePNGUri($code, $type, $w = 3, $h = 3, $color = [0, 0, 0])
	{
	 ...
	 * @protected
	 */
	protected function getBarcodePNGPath($code, $type, $w = 3, $h = 3, $color = [0, 0, 0])
	{
		if (!$this->store_path) {
			$this->setStorPath(app('config')->get('barcode.store_path'));
		}
