...
class MessageCatalogueTest extends TestCase
{
	...
	public function testGetDomains()
	{
		...
		$this->assertSame(['domain1', 'domain2'], $catalogue->getDomains());
	}
	...
	public function testAll()
	{
		...
		$this->assertSame(['foo' => 'foo'], $catalogue->all('domain1'));
		$this->assertSame([], $catalogue->all('domain88'));
	...
	public function testGetSet()
	{
		...
		$this->assertSame('foo', $catalogue->get('foo', 'domain1'));
	...
	public function testAdd()
	{
		...
		$this->assertSame('bar', $catalogue->get('foo', 'domain88'));
	}
	...
	public function testReplace()
	{
		...
		$this->assertSame($messages, $catalogue->all('domain1'));
	}
	...
	public function testAddCatalogue()
	{
		...
		$this->assertSame([$r, $r1], $catalogue->getResources());
	}
	...
	public function testAddFallbackCatalogue()
	{
		...
		$this->assertSame([$r, $r1, $r2], $catalogue->getResources());
	}
	...
	{
		$catalogue = new MessageCatalogue('en');
		$this->assertSame([], $catalogue->getMetadata('', ''), 'Metadata is empty');
	...
	public function testMetadataSetGetDelete()
	{
		...
		$this->assertSame('value', $catalogue->getMetadata('key', 'messages'), "Metadata 'key' = 'value'");

		$catalogue->setMetadata('key2', []);
		$this->assertSame([], $catalogue->getMetadata('key2', 'messages'), 'Metadata key2 is array');
	...
	public function testMetadataMerge()
	{
		...
		$this->assertSame(['messages' => ['a' => 'b']], $cat1->getMetadata('', ''), 'Cat1 contains messages metadata.');

		$cat2 = new MessageCatalogue('en');
		$cat2->setMetadata('b', 'c', 'domain');
		$this->assertSame(['domain' => ['b' => 'c']], $cat2->getMetadata('', ''), 'Cat2 contains domain metadata.');

		$cat1->addCatalogue($cat2);
		$this->assertSame(['messages' => ['a' => 'b'], 'domain' => ['b' => 'c']], $cat1->getMetadata('', ''), 'Cat1 contains merged metadata.');
	}
}
