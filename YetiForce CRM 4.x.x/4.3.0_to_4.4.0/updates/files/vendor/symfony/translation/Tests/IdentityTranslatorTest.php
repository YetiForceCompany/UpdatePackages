...
class IdentityTranslatorTest extends TestCase
{
	...
	public function testTrans($expected, $id, $parameters)
	{
		...
		$this->assertSame($expected, $translator->trans($id, $parameters));
	}
	...
	public function testTransChoiceWithExplicitLocale($expected, $id, $number, $parameters)
	{
		...
		$this->assertSame($expected, $translator->transChoice($id, $number, $parameters));
	}
	...
	public function testGetLocaleReturnsDefaultLocaleIfNotSet()
	{
		...
		$this->assertSame('pt_BR', $translator->getLocale());
	}
