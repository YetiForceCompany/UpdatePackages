...
class PoFileLoaderTest extends TestCase
{
	public function testLoad()
	{
		...
		$this->assertSame(['foo' => 'bar'], $catalogue->all('domain1'));
	...
	public function testLoadPlurals()
	{
		...
		$this->assertSame(['foo' => 'bar', 'foos' => 'bar|bars'], $catalogue->all('domain1'));
		$this->assertSame('en', $catalogue->getLocale());
		$this->assertSame([new FileResource($resource)], $catalogue->getResources());
	}
	...
	public function testLoadDoesNothingIfEmpty()
	{
		...
		$this->assertSame([], $catalogue->all('domain1'));
		$this->assertSame('en', $catalogue->getLocale());
		$this->assertSame([new FileResource($resource)], $catalogue->getResources());
	}
	...
	public function testLoadEmptyTranslation()
	{
		...
		$this->assertSame(['foo' => ''], $catalogue->all('domain1'));
		$this->assertSame('en', $catalogue->getLocale());
		$this->assertSame([new FileResource($resource)], $catalogue->getResources());
	}
	...
	public function testEscapedId()
	{
		...
		$this->assertSame('escaped "bar"', $messages['escaped "foo"']);
	}
	...
	public function testEscapedIdPlurals()
	{
		...
		$this->assertSame('escaped "bar"', $messages['escaped "foo"']);
		$this->assertSame('escaped "bar"|escaped "bars"', $messages['escaped "foos"']);
	}
