...
class TranslatorTest extends TestCase
{
	...
	public function testGetCatalogue()
	{
		...
		$this->assertSame(new MessageCatalogue('en'), $translator->getCatalogue());

		$translator->setLocale('fr');
		$this->assertSame(new MessageCatalogue('fr'), $translator->getCatalogue('fr'));
	}
	...
	public function testSetFallbackLocalesMultiple()
	{
		...
		$this->assertSame('bar (fr)', $translator->trans('bar'));
	}
	...
	public function testTransWithFallbackLocaleFile($format, $loader)
	{
		...
		$this->assertSame('bar', $translator->trans('foo', [], 'resources'));
	}
	...
	public function testTransWithFallbackLocaleTer()
	{
		...
		$this->assertSame('foo (en_US)', $translator->trans('foo'));
		$this->assertSame('bar (en)', $translator->trans('bar'));
	}
	...
	public function testTransNonExistentWithFallback()
	{
		...
		$translator->setFallbackLocales(['en']);
		$translator->addLoader('array', new ArrayLoader());
		$this->assertSame('non-existent', $translator->trans('non-existent'));
	}
	...
	public function testTrans($expected, $id, $translation, $parameters, $locale, $domain)
	{
		...
		$this->assertSame($expected, $translator->trans($id, $parameters, $domain, $locale));
	}
	...
	public function testTransValidLocale($locale)
	{
		...
		$this->assertSame('OK', $translator->trans('test'));
		$this->assertSame('OK', $translator->trans('test', [], null, $locale));
	}
	...
	public function testFlattenedTrans($expected, $messages, $id)
	{
		...
		$this->assertSame($expected, $translator->trans($id, [], '', 'fr'));
	}
	...
	public function testTransChoice($expected, $id, $translation, $number, $parameters, $locale, $domain)
	{
		...
		$this->assertSame($expected, $translator->transChoice($id, $number, $parameters, $domain, $locale));
	}
	...
	public function testTransChoiceFallback()
	{
		...
		$this->assertSame('10 things', $translator->transChoice('some_message2', 10, ['%count%' => 10]));
	}
	...
	public function testTransChoiceFallbackWithNoTranslation()
	{
		...
		$this->assertSame('some_message2', $translator->transChoice('some_message2', 10, ['%count%' => 10]));
	}
}
