...
class TranslatorCacheTest extends TestCase
{
	...
	public function testThatACacheIsUsed($debug)
	{
		...
		$translator->addResource($format, [$msgid => 'OK'], $locale);
		$this->assertSame('OK', $translator->trans($msgid), '-> caching does not work in ' . ($debug ? 'debug' : 'production'));
	}
	...
	public function testDifferentTranslatorsForSameLocaleDoNotOverwriteEachOthersCache($debug)
	{
		...
		$translator->addLoader($format, $this->createFailingLoader());
		$translator->addResource($format, [$msgid => 'OK'], $locale);
		$this->assertSame('OK', $translator->trans($msgid), '-> the cache was overwritten by another translator instance in ' . ($debug ? 'debug' : 'production'));
	}
	...
	public function testDifferentCacheFilesAreUsedForDifferentSetsOfFallbackLocales()
	{
		...
		$this->assertSame('bar (b)', $translator->trans('bar'));
