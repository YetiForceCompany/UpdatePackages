...
class MessageFormatterTest extends TestCase
{
	...
	{
		$this->assertSame($expected, $this->getMessageFormatter()->format($message, 'en', $parameters));
	}
	...
	{
		$this->assertSame($expected, $this->getMessageFormatter()->choiceFormat($message, $number, 'fr', $parameters));
	}
