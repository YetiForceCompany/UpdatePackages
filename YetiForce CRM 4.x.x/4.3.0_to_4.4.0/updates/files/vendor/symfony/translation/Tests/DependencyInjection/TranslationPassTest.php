...
class TranslationPassTest extends TestCase
{
	public function testValidCollector()
	{
		...
		$this->assertSame($expectedReader, $reader);

		$expectedLoader = (new Definition())
			->addTag('translation.loader', ['alias' => 'xliff', 'legacy-alias' => 'xlf']);
		$this->assertSame($expectedLoader, $loader);
		...
		$this->assertSame($expected, $container->getDefinition((string) $translator->getArgument(0))->getArgument(0));
	}
}
