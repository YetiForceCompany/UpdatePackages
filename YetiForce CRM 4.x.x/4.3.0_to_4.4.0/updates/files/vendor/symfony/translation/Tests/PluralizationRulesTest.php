...
class PluralizationRulesTest extends TestCase
{
	...
	protected function validateMatrix($nplural, $matrix, $expectSuccess = true)
	{
		foreach ($matrix as $langCode => $data) {
			...
			if ($expectSuccess) {
				$this->assertSame($nplural, count($indexes), "Langcode '$langCode' has '$nplural' plural forms.");
			} else {
				$this->assertNotSame((int) $nplural, count($indexes), "Langcode '$langCode' has '$nplural' plural forms.");
			}
		}
	}
