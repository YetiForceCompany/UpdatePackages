...
class IcuDatFileLoaderTest extends LocalizedTestCase
{
	...
	public function testDatEnglishLoad()
	{
		...
		$this->assertSame(['symfony' => 'Symfony 2 is great'], $catalogue->all('domain1'));
		$this->assertSame('en', $catalogue->getLocale());
		$this->assertSame([new FileResource($resource . '.dat')], $catalogue->getResources());
	}
	...
	public function testDatFrenchLoad()
	{
		...
		$this->assertSame(['symfony' => 'Symfony 2 est génial'], $catalogue->all('domain1'));
		$this->assertSame('fr', $catalogue->getLocale());
		$this->assertSame([new FileResource($resource . '.dat')], $catalogue->getResources());
	}
