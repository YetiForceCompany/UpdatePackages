...
class AddConsoleCommandPassTest extends TestCase
{
	...
	public function testProcessRegistersLazyCommands()
	{
		...
		$this->assertSame([['my-command' => new ServiceClosureArgument(new TypedReference('my-command', MyCommand::class))]], $commandLocator->getArguments());
	...
	public function testProcessFallsBackToDefaultName()
	{
		...
		$this->assertSame([['with-default-name' => new ServiceClosureArgument(new TypedReference('with-default-name', NamedCommand::class))]], $commandLocator->getArguments());
		$this->assertSame([], $container->getParameter('console.command.ids'));
