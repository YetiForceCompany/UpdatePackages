...
class HelperSetTest extends TestCase
{
	public function testConstructor()
	{
		...
		$this->assertSame($mock_helper, $helperset->get('fake_helper_alias'), '__construct sets given helper to helpers');
	...
	public function testGet()
	{
		...
		$this->assertSame($helper_01, $helperset->get('fake_helper_01'), '->get() returns correct helper by name');
		$this->assertSame($helper_01, $helperset->get('fake_helper_01_alias'), '->get() returns correct helper by alias');
		$this->assertSame($helper_02, $helperset->get('fake_helper_02'), '->get() returns correct helper by name');
		$this->assertSame($helper_02, $helperset->get('fake_helper_02_alias'), '->get() returns correct helper by alias');
	...
	public function testSetCommand()
	{
		...
		$this->assertSame($cmd_01, $helperset->getCommand(), '->setCommand() stores given command');

		$helperset = new HelperSet();
		$helperset->setCommand($cmd_01);
		$helperset->setCommand($cmd_02);
		$this->assertSame($cmd_02, $helperset->getCommand(), '->setCommand() overwrites stored command with consecutive calls');
	}
	...
	public function testGetCommand()
	{
		...
		$this->assertSame($cmd, $helperset->getCommand(), '->getCommand() retrieves stored command');
	}
	...
	public function testIteration()
	{
		...
		foreach ($helperset as $helper) {
			$this->assertSame($helpers[$i++], $helper->getName());
		}
	}
