...
class ApplicationTest extends TestCase
{
	...
	public function testConstructor()
	{
		...
		$this->assertSame('foo', $application->getName(), '__construct() takes the application name as its first argument');
		$this->assertSame('bar', $application->getVersion(), '__construct() takes the application version as its second argument');
		$this->assertSame(['help', 'list'], array_keys($application->all()), '__construct() registered the help and list commands by default');
	}
	...
	public function testSetGetName()
	{
		...
		$this->assertSame('foo', $application->getName(), '->setName() sets the name of the application');
	}
	...
	public function testSetGetVersion()
	{
		...
		$this->assertSame('bar', $application->getVersion(), '->setVersion() sets the version of the application');
	}

	public function testGetLongVersion()
	{
		$application = new Application('foo', 'bar');
		$this->assertSame('foo <info>bar</info>', $application->getLongVersion(), '->getLongVersion() returns the long version of the application');
	}
	...
	public function testRegister()
	{
		...
		$this->assertSame('foo', $command->getName(), '->register() registers a new command');
	}
	...
	public function testAdd()
	{
		...
		$commands = $application->all();
		$this->assertSame($foo, $commands['foo:bar'], '->add() registers a command');

		$application = new Application();
		$application->addCommands([$foo = new \FooCommand(), $foo1 = new \Foo1Command()]);
		$commands = $application->all();
		$this->assertSame([$foo, $foo1], [$commands['foo:bar'], $commands['foo:bar1']], '->addCommands() registers an array of commands');
	}
	...
	public function testHasGet()
	{
		...
		$this->assertSame($foo, $application->get('foo:bar'), '->get() returns a command by name');
		$this->assertSame($foo, $application->get('afoobar'), '->get() returns a command by alias');
	...
	public function testHasGetWithCommandLoader()
	{
		...
		$this->assertSame($foo, $application->get('foo:bar'), '->get() returns an instance by name even with command loader');
		$this->assertSame($foo, $application->get('afoobar'), '->get() returns an instance by alias even with command loader');
		...
		$this->assertSame($foo1, $application->get('afoobar1'), '->get() returns a command by name from the command loader');
	}
	...
	public function testGetNamespaces()
	{
		...
		$this->assertSame(['foo'], $application->getNamespaces(), '->getNamespaces() returns an array of unique used namespaces');
	}
	...
	public function testFindNamespace()
	{
		$application = new Application();
		$application->add(new \FooCommand());
		$this->assertSame('foo', $application->findNamespace('foo'), '->findNamespace() returns the given namespace if it exists');
		$this->assertSame('foo', $application->findNamespace('f'), '->findNamespace() finds a namespace given an abbreviation');
	...
	public function testFindNamespaceWithSubnamespaces()
	{
		...
		$this->assertSame('foo', $application->findNamespace('foo'), '->findNamespace() returns commands even if the commands are only contained in subnamespaces');
	}
	...
	public function testFindNonAmbiguous()
	{
		...
		$this->assertSame('test-toto', $application->find('test')->getName());
	}
...
', $tester->getDisplay(true));
	...
	public function testFindAlternativeCommands()
	{
		...
		try {
			...
			$this->assertSame(sprintf('Command "%s" is not defined.', $commandName), $e->getMessage(), '->find() throws a CommandNotFoundException if command does not exist, without alternatives');
		}
	...
	public function testFindAlternativeNamespace()
	{
		...
		try {
			...
			$this->assertSame([], $e->getAlternatives());
			$this->assertSame('There are no commands defined in the "Unknown-namespace" namespace.', $e->getMessage(), '->find() throws a CommandNotFoundException if namespace does not exist, without alternatives');
		}
	...
	public function testFindNamespaceDoesNotFailOnDeepSimilarNamespaces()
	{
		...
		$this->assertSame('foo:sublong', $application->findNamespace('f:sub'));
	}
	...
	public function testSetCatchExceptions()
	{
		...
		try {
			...
			$this->assertSame('Command "foo" is not defined.', $e->getMessage(), '->setCatchExceptions() sets the catch exception flag');
		}
	}
	...
	public function testRunWithDispatcher()
	{
		...
		$this->assertSame('before.foo.after.' . PHP_EOL, $tester->getDisplay());
	}
	...
	public function testRunWithDispatcherAddingInputOptions()
	{
		...
		$this->assertSame('some test value', $extraValue);
	}
	...
	public function testSetRunCustomDefaultCommand()
	{
		...
		$this->assertSame('called' . PHP_EOL, $tester->getDisplay(), 'Application runs the default set command if different from \'list\' command');
	...
	public function testSetRunCustomDefaultCommandWithOption()
	{
		...
		$this->assertSame('called' . PHP_EOL . 'opt' . PHP_EOL, $tester->getDisplay(), 'Application runs the default set command if different from \'list\' command');
	}
	...
	public function testCanCheckIfTerminalIsInteractive()
	{
		...
		$this->assertSame($tester->getInput()->isInteractive(), @posix_isatty($inputStream));
	}
	...
	{
		$application = new Application();
		$application->setCommandLoader(new FactoryCommandLoader(['disabled' => function () {
