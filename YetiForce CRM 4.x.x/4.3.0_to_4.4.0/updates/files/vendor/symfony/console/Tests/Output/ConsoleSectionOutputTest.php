...
class ConsoleSectionOutputTest extends TestCase
{
	...
	public function testClearAll()
	{
		...
		$this->assertSame('Foo' . PHP_EOL . 'Bar' . PHP_EOL . sprintf("\x1b[%dA", 2) . "\x1b[0J", stream_get_contents($output->getStream()));
	}
	...
	public function testClearNumberOfLinesWithMultipleSections()
	{
		...
		$this->assertSame('Foo' . PHP_EOL . 'Bar' . PHP_EOL . "\x1b[1A\x1b[0J\e[1A\e[0J" . 'Baz' . PHP_EOL . 'Foo' . PHP_EOL, stream_get_contents($output->getStream()));
	}
	...
	public function testClearPreservingEmptyLines()
	{
		...
		$this->assertSame(PHP_EOL . 'foo' . PHP_EOL . "\x1b[1A\x1b[0J\x1b[1A\x1b[0J" . 'bar' . PHP_EOL . PHP_EOL, stream_get_contents($output->getStream()));
	}
	...
	public function testOverwrite()
	{
		...
		rewind($output->getStream());
		$this->assertSame('Foo' . PHP_EOL . "\x1b[1A\x1b[0JBar" . PHP_EOL, stream_get_contents($output->getStream()));
	}
	...
	public function testOverwriteMultipleLines()
	{
		...
		rewind($output->getStream());
		$this->assertSame('Foo' . PHP_EOL . 'Bar' . PHP_EOL . 'Baz' . PHP_EOL . sprintf("\x1b[%dA", 3) . "\x1b[0J" . 'Bar' . PHP_EOL, stream_get_contents($output->getStream()));
	}
	...
	public function testMultipleSectionsOutput()
	{
		...
		rewind($output->getStream());
		$this->assertSame('Foo' . PHP_EOL . 'Bar' . PHP_EOL . "\x1b[2A\x1b[0JBar" . PHP_EOL . "\x1b[1A\x1b[0JBaz" . PHP_EOL . 'Bar' . PHP_EOL . "\x1b[1A\x1b[0JFoobar" . PHP_EOL, stream_get_contents($output->getStream()));
	}
}
