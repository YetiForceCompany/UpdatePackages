...
class OutputFormatterStyleTest extends TestCase
{
	public function testConstructor()
	{
		...
		$this->assertSame("\033[32;40;1;4mfoo\033[39;49;22;24m", $style->apply('foo'));

		$style = new OutputFormatterStyle('red', null, ['blink']);
		$this->assertSame("\033[31;5mfoo\033[39;25m", $style->apply('foo'));

		$style = new OutputFormatterStyle(null, 'white');
		$this->assertSame("\033[47mfoo\033[49m", $style->apply('foo'));
	}
	...
	public function testForeground()
	{
		...
		$this->assertSame("\033[30mfoo\033[39m", $style->apply('foo'));

		$style->setForeground('blue');
		$this->assertSame("\033[34mfoo\033[39m", $style->apply('foo'));

		$style->setForeground('default');
		$this->assertSame("\033[39mfoo\033[39m", $style->apply('foo'));
	...
	public function testBackground()
	{
		...
		$this->assertSame("\033[40mfoo\033[49m", $style->apply('foo'));

		$style->setBackground('yellow');
		$this->assertSame("\033[43mfoo\033[49m", $style->apply('foo'));

		$style->setBackground('default');
		$this->assertSame("\033[49mfoo\033[49m", $style->apply('foo'));
	...
	public function testOptions()
	{
		...
		$this->assertSame("\033[7;8mfoo\033[27;28m", $style->apply('foo'));

		$style->setOption('bold');
		$this->assertSame("\033[7;8;1mfoo\033[27;28;22m", $style->apply('foo'));

		$style->unsetOption('reverse');
		$this->assertSame("\033[8;1mfoo\033[28;22m", $style->apply('foo'));

		$style->setOption('bold');
		$this->assertSame("\033[8;1mfoo\033[28;22m", $style->apply('foo'));

		$style->setOptions(['bold']);
		$this->assertSame("\033[1mfoo\033[22m", $style->apply('foo'));
