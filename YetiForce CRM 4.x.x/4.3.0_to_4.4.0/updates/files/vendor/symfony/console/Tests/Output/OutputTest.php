...
class OutputTest extends TestCase
{
	public function testConstructor()
	{
		...
		$this->assertSame(Output::VERBOSITY_QUIET, $output->getVerbosity(), '__construct() takes the verbosity as its first argument');
	...
	public function testSetGetVerbosity()
	{
		...
		$this->assertSame(Output::VERBOSITY_QUIET, $output->getVerbosity(), '->setVerbosity() sets the verbosity');
	...
	public function testWriteWithVerbosityQuiet()
	{
		...
		$output->writeln('foo');
		$this->assertSame('', $output->output, '->writeln() outputs nothing if verbosity is set to VERBOSITY_QUIET');
	}
	...
	public function testWriteRawMessage($message, $type, $expectedOutput)
	{
		...
		$this->assertSame($expectedOutput, $output->output);
	}
	...
	public function testWriteDecoratedMessage()
	{
		...
		$this->assertSame("\033[33;41;5mfoo\033[39;49;25m\n", $output->output, '->writeln() decorates the output');
	}
	...
	public function testWriteWithInvalidStyle()
	{
		...
		$this->assertSame('<bar>foo</bar>', $output->output, '->write() do nothing when a style does not exist');
	...
	public function testWriteWithVerbosityOption($verbosity, $expected, $msg)
	{
		...
		$this->assertSame($expected, $output->output, $msg);
	}
