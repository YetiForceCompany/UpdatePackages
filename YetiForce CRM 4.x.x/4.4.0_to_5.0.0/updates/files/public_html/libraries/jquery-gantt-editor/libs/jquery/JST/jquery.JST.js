$.fn.loadTemplates = function (renderFunctions = []) {
	$.JST.loadTemplates($(this));
	renderFunctions.forEach(({type,render})=>{
		$.JST.setTemplateFunction(type,render);
	});
	return this;
};
...
$.JST = {
	...
	/**
	 * Set template directly from function - do not evaluate html
	 * @param {string} type
	 * @param {function} renderFn
	 */
	setTemplateFunction(type,renderFn){
		$.JST._templates[type]=renderFn;
	},
