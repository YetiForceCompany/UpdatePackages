...
regex:/^[\-\+]?((([0-9]{1,3})([,][0-9]{3})*)|([0-9]+))?([\.]([0-9]+))?$/,alertText:"* Invalid floating decimal number"},date:{//	Check if date is valid by leap year
...
//# sourceMappingURL=jquery.validationEngine-en.min.js.map
