	...
	public function scheme()
	{
		$this->tables = [
			...
			'vtiger_recurring_frequency' => [
				'columns' => [
					'recurring_frequency_id' => $this->integer(10)->autoIncrement()->notNull(),
					'recurring_frequency' => $this->stringType(200),
					'sortorderid' => $this->integer(10),
					'presence' => $this->integer(10),
				],
				'primaryKeys' => [
					['recurring_frequency_pk', 'recurring_frequency_id']
				],
				'engine' => 'InnoDB',
				'charset' => 'utf8'
			],
			...
			'vtiger_salutationtype' => [
				'columns' => [
					'salutationtypeid' => $this->integer(10)->autoIncrement()->notNull(),
				...
				'primaryKeys' => [
					['salutationtype_pk', 'salutationtypeid']
				],
				'engine' => 'InnoDB',
				'charset' => 'utf8'
			],
			...
			'vtiger_service' => [
				'columns' => [
					...
					'commissionrate' => $this->decimal('8,3'),
			...
			'vtiger_smsnotifier_status' => [
				'columns' => [
					'smsnotifier_statusid' => $this->integer(10)->autoIncrement()->notNull(),
					'smsnotifier_status' => $this->stringType(),
				...
				'primaryKeys' => [
					['smsnotifier_status_pk', 'smsnotifier_statusid']
				],
				'engine' => 'InnoDB',
				'charset' => 'utf8'
			],
			...
			'vtiger_ssingleorders_method_payments' => [
				'columns' => [
					'ssingleorders_method_paymentsid' => $this->integer()->autoIncrement()->notNull(),
				...
				'primaryKeys' => [
					['ssingleorders_method_payments_pk', 'ssingleorders_method_paymentsid']
				],
				'engine' => 'InnoDB',
				'charset' => 'utf8'
			],
			...
			'vtiger_sync_caldav' => [
				'columns' => [
					'sync_caldavid' => $this->integer()->autoIncrement()->notNull(),
					'sync_caldav' => $this->stringType(),
					'presence' => $this->smallInteger(1)->defaultValue(1),
					'sortorderid' => $this->smallInteger()->defaultValue(0),
				],
				'columns_mysql' => [
			...
			'vtiger_sync_carddav' => [
				'columns' => [
					'sync_carddavid' => $this->integer()->autoIncrement()->notNull(),
					'sync_carddav' => $this->stringType(),
					'presence' => $this->smallInteger(1)->defaultValue(1),
					'sortorderid' => $this->smallInteger()->defaultValue(0),
				],
				'columns_mysql' => [
				...
				'primaryKeys' => [
					['sync_carddav_pk', 'sync_carddavid']
				],
				'engine' => 'InnoDB',
				'charset' => 'utf8'
			],
			...
			'vtiger_ticketstatus' => [
				'columns' => [
					...
					'time_counting' => $this->smallInteger(1)->notNull()->defaultValue(0),
				],
				'columns_mysql' => [
					'record_state' => $this->tinyInteger(1)->notNull()->defaultValue(0),
					'time_counting' => $this->tinyInteger(1)->notNull()->defaultValue(0),
				],
				'primaryKeys' => [
			...
			'vtiger_troubletickets' => [
				'columns' => [
					...
					'response_range_time' => $this->integer(),
					'solution_range_time' => $this->integer(),
					'idle_range_time' => $this->integer(),
					'closing_range_time' => $this->integer(),
					'response_datatime' => $this->dateTime(),
					'solution_datatime' => $this->dateTime(),
					'idle_datatime' => $this->dateTime(),
					'closing_datatime' => $this->dateTime(),
					'response_expected' => $this->dateTime(),
				...
				'index' => [
					...
					['pssold_id', 'pssold_id'],
					['ticket_no', 'ticket_no'],
					['vtiger_troubletickets_parentid_idx', 'parentid'],
				],
				'primaryKeys' => [
			...
			'vtiger_troubletickets_state_history' => [
				'columns' => [
					'id' => $this->integer(10)->unsigned()->autoIncrement()->notNull(),
					'crmid' => $this->integer(),
					'before' => $this->smallInteger(1)->notNull()->defaultValue(0),
					'after' => $this->smallInteger(1)->notNull()->defaultValue(0),
					'date' => $this->timestamp()->null(),
				],
				'columns_mysql' => [
					'before' => $this->tinyInteger(1)->notNull()->defaultValue(0),
					'after' => $this->tinyInteger(1)->notNull()->defaultValue(0),
				],
				'index' => [
					['vtiger_troubletickets_state_history_crmid_idx', 'crmid'],
				],
				'primaryKeys' => [
					['troubletickets_state_history_pk', 'id']
				],
				'engine' => 'InnoDB',
				'charset' => 'utf8'
			],
			'vtiger_usageunit' => [
				...
				'index' => [
					['usageunit_usageunit_idx', 'usageunit'],
				],
				'primaryKeys' => [
			...
			'vtiger_users' => [
				'columns' => [
					...
					'login_method' => $this->stringType()->defaultValue('PLL_PASSWORD'),
					'sync_carddav' => $this->stringType(100)->defaultValue('PLL_OWNER'),
					'sync_caldav' => $this->stringType(100)->defaultValue('PLL_OWNER'),
					'sync_carddav_default_country' => $this->stringType(),
					'default_search_module' => $this->stringType(25),
					'default_search_override' => $this->smallInteger(1),
				],
				'columns_mysql' => [
					...
					'default_search_override' => $this->tinyInteger(1),
				],
				'index' => [
					['email1', 'email1'],
			...
			'vtiger_view_date_format' => [
				'columns' => [
					'view_date_formatid' => $this->integer()->autoIncrement()->notNull(),
				...
				'primaryKeys' => [
					['view_date_format_pk', 'view_date_formatid']
				],
				'engine' => 'InnoDB',
				'charset' => 'utf8'
			],
			'vtiger_visibility' => [
				...
				'index' => [
					['visibility_visibility_idx', 'visibility'],
				],
				'primaryKeys' => [
			...
			'yetiforce_auth' => [
				'columns' => [
					'id' => $this->smallInteger(3)->unsigned()->autoIncrement()->notNull(),
					'type' => $this->stringType(20),
					'param' => $this->stringType(20),
					'value' => $this->text(),
				],
				'columns_mysql' => [
					'id' => $this->tinyInteger(3)->unsigned()->autoIncrement()->notNull(),
				],
				'index' => [
					['type', ['type', 'param']],
				],
				'primaryKeys' => [
					['yetiforce_auth_pk', 'id']
				],
				'engine' => 'InnoDB',
				'charset' => 'utf8'
			],
			'yetiforce_currencyupdate' => [
				...
				'index' => [
					['fetchdate_currencyid_unique', ['currency_id', 'exchange_date', 'bank_id']],
		...
		$this->foreignKey = [
			...
			['fk_1_vtiger_troubletickets_state_history', 'vtiger_troubletickets_state_history', 'crmid', 'vtiger_crmentity', 'crmid', 'CASCADE', 'RESTRICT'],
		...
		$this->data = [
			...
			'vtiger_relatedlists' => [
				...
				'values' => [
					...
					[164, 35, 19, 'getServicePricebooks', 6, 'PriceBooks', 0, 'ADD,SELECT', 0, 0, 0],
			...
			'vtiger_reservations_status' => [
				'columns' => ['reservations_statusid', 'reservations_status', 'sortorderid', 'presence', 'picklist_valueid'],
				'values' => [
					[1, 'PLL_ACCEPTED', 2, 1, 851],
					[2, 'PLL_TO_APPROVAL', 3, 1, 852],
					[3, 'PLL_DRAFT', 1, 1, 853],
					[4, 'PLL_CANCELLED', 4, 1, 854],
				]
			],
			...
			'vtiger_scalculations_status' => [
				'columns' => ['scalculations_statusid', 'scalculations_status', 'sortorderid', 'presence', 'picklist_valueid'],
				'values' => [
					[1, 'PLL_DRAFT', 1, 1, 855],
					[2, 'PLL_IN_REALIZATION', 2, 1, 856],
					[3, 'PLL_FOR_VERIFICATION', 3, 1, 857],
					[4, 'PLL_CANCELLED', 4, 0, 858],
					[5, 'PLL_COMPLETED', 5, 0, 859],
				]
			],
			...
			'vtiger_settings_field' => [
				...
				'values' => [
					...
					[107, 5, 'LBL_SMSNOTIFIER', 'userIcon-SMSNotifier', 'LBL_SMSNOTIFIER_DESCRIPTION', 'index.php?module=SMSNotifier&parent=Settings&view=List', 12, 0, 0, null],
				]
			],
			'vtiger_smsnotifier_status' => [
				'columns' => ['smsnotifier_statusid', 'smsnotifier_status', 'presence', 'sortorderid'],
				'values' => [
					[1, 'PLL_UNDEFINED', 0, 1],
					[2, 'PLL_DELIVERED', 0, 2],
					[3, 'PLL_FAILED', 0, 3],
			...
			'vtiger_squoteenquiries_status' => [
				'columns' => ['squoteenquiries_statusid', 'squoteenquiries_status', 'sortorderid', 'presence', 'picklist_valueid'],
				'values' => [
					[1, 'PLL_DRAFT', 1, 1, 860],
					[2, 'PLL_IN_REALIZATION', 2, 1, 861],
					[3, 'PLL_FOR_VERIFICATION', 3, 1, 862],
					[4, 'PLL_CANCELLED', 4, 0, 863],
					[5, 'PLL_COMPLETED', 5, 0, 864],
				]
			],
			'vtiger_squotes_status' => [
				'columns' => ['squotes_statusid', 'squotes_status', 'sortorderid', 'presence', 'picklist_valueid'],
				'values' => [
					[1, 'PLL_DRAFT', 1, 1, 865],
					[2, 'PLL_IN_REALIZATION', 2, 1, 866],
					[3, 'PLL_FOR_VERIFICATION', 3, 1, 867],
					[4, 'PLL_AWAITING_DECISION', 4, 1, 868],
					[5, 'PLL_NEGOTIATIONS', 5, 1, 869],
					[6, 'PLL_CANCELLED', 6, 0, 870],
					[7, 'PLL_ACCEPTED', 7, 0, 871],
				]
			],
			'vtiger_srecurringorders_status' => [
				'columns' => ['srecurringorders_statusid', 'srecurringorders_status', 'sortorderid', 'presence', 'picklist_valueid'],
				'values' => [
					[1, 'PLL_DRAFT', 1, 1, 872],
					[2, 'PLL_REQUIRES_TO_BE_COMPLEMENTED', 2, 1, 873],
					[3, 'PLL_REQUIRES_CONSULTATION', 3, 1, 874],
					[4, 'PLL_WAITING_FOR_SHIPPING', 4, 1, 875],
					[5, 'PLL_WAITING_FOR_SIGNATURE', 5, 1, 876],
					[6, 'PLL_WAITING_FOR_REALIZATION', 6, 1, 877],
					[7, 'PLL_AUTOMATIC_GENERATION', 7, 0, 878],
					[8, 'PLL_UNREALIZED', 8, 0, 879],
					[9, 'PLL_REALIZED', 9, 0, 880],
				]
			],
			'vtiger_srequirementscards_status' => [
				'columns' => ['srequirementscards_statusid', 'srequirementscards_status', 'sortorderid', 'presence', 'picklist_valueid'],
				'values' => [
					[1, 'PLL_DRAFT', 1, 1, 881],
					[2, 'PLL_IN_REALIZATION', 2, 1, 882],
					[3, 'PLL_FOR_VERIFICATION', 3, 1, 883],
					[4, 'PLL_CANCELLED', 4, 0, 884],
					[5, 'PLL_COMPLETED', 5, 0, 885],
				]
			],
			'vtiger_ssalesprocesses_source' => [
			...
			'vtiger_ssalesprocesses_status' => [
				'columns' => ['ssalesprocesses_statusid', 'ssalesprocesses_status', 'sortorderid', 'presence', 'picklist_valueid'],
				'values' => [
					[1, 'PLL_DRAFT', 1, 1, 886],
					[2, 'PLL_FOR_REALIZATION', 2, 1, 887],
					[3, 'PLL_QUOTE_ENQUIRY', 3, 1, 888],
					[4, 'PLL_REQUIREMENTS_CARD', 4, 1, 889],
					[5, 'PLL_CALCULATION', 5, 1, 890],
					[6, 'PLL_QUOTE', 6, 1, 891],
					[7, 'PLL_NEGOTIATIONS', 7, 1, 892],
					[8, 'PLL_AWAITING_DECISION', 8, 1, 893],
					[9, 'PLL_AWAITING_SIGNATURES', 9, 1, 894],
					[10, 'PLL_ORDER', 10, 1, 895],
					[11, 'PLL_REALIZATION', 11, 1, 896],
					[12, 'PLL_AWAITING_PAYMENT', 12, 1, 897],
					[13, 'PLL_INVOICING', 13, 1, 898],
					[14, 'PLL_SALE_COMPLETED', 14, 0, 899],
					[15, 'PLL_SALE_FAILED', 15, 0, 900],
					[16, 'PLL_SALE_CANCELLED', 16, 0, 901],
				]
			],
			'vtiger_ssalesprocesses_type' => [
			...
			'vtiger_ssingleorders_status' => [
				'columns' => ['ssingleorders_statusid', 'ssingleorders_status', 'sortorderid', 'presence', 'picklist_valueid'],
				'values' => [
					[1, 'PLL_DRAFT', 1, 1, 902],
					[2, 'PLL_IN_REALIZATION', 2, 1, 903],
					[3, 'PLL_FOR_VERIFICATION', 3, 1, 904],
					[4, 'PLL_AWAITING_SIGNATURES', 4, 1, 905],
					[5, 'PLL_CANCELLED', 5, 0, 906],
					[6, 'PLL_ACCEPTED', 6, 0, 907],
				]
			],
			'vtiger_ssservicesstatus' => [
			...
			'vtiger_storage_status' => [
				'columns' => ['storage_statusid', 'storage_status', 'sortorderid', 'presence', 'picklist_valueid'],
				'values' => [
					[1, 'PLL_ACTIVE', 1, 1, 908],
					[2, 'PLL_INACTIVE', 2, 1, 909],
				]
			],
			'vtiger_storage_type' => [
			...
			'vtiger_trees_templates' => [
				'columns' => ['templateid', 'name', 'module', 'access', 'share'],
				'values' => [
					[1, 'System', 8, 0, null],
					[2, 'Category', 14, 0, null],
					[3, 'Category', 35, 0, null],
					[4, 'Category', 57, 0, null],
					[5, 'Category', 58, 0, null],
					[6, 'Category', 59, 0, null],
					[7, 'Reservations', 84, 0, null],
					[8, 'Category', 85, 0, null],
					[9, 'Category', 86, 0, null],
					[10, 'Category', 87, 0, null],
					[11, 'Category', 88, 0, null],
					[12, 'Category', 89, 0, null],
					[13, 'Category', 90, 0, null],
					[14, 'Category', 91, 0, null],
					[15, 'Category', 37, 0, null],
					[16, 'Category', 96, 0, null],
					[17, 'Category', 13, 0, null],
					[18, 'Category', 92, 0, null],
					[19, 'Category', 113, 1, null],
					[20, 'Category', 115, 1, null],
					[21, 'Category', 95, 1, null],
					[22, 'Category', 117, 0, null],
				]
			],
			'vtiger_trees_templates_data' => [
