...
class Admin extends \App\Db\Importers\Base
{
	...
	public function scheme()
	{
		$this->tables = [
			...
			'a_#__pdf' => [
				'columns' => [
					'pdfid' => $this->integer(10)->unsigned()->autoIncrement()->notNull(),
			...
			'b_#__social_media_twitter' => [
				...
				'primaryKeys' => [
					['b_#__social_media_twitter_pk', 'id']
				],
				'engine' => 'InnoDB',
				'charset' => 'utf8'
			],
			...
			's_#__pbx' => [
				'columns' => [
					'pbxid' => $this->smallInteger(5)->unsigned()->autoIncrement()->notNull(),
					'default' => $this->smallInteger(1)->unsigned()->notNull()->defaultValue(0),
