	...
	public function scheme()
	{
		$this->tables = [
			...
			'com_vtiger_workflowtasks_entitymethod' => [
				'columns' => [
					'workflowtasks_entitymethod_id' => $this->integer(10)->autoIncrement()->notNull(),
					'module_name' => $this->stringType(100),
			...
			'u_#__chat_global' => [
				'columns' => [
					'global_room_id' => $this->integer(10)->unsigned()->autoIncrement()->notNull(),
			...
			'u_#__chat_messages_group' => [
				'columns' => [
					'id' => $this->bigInteger(10)->unsigned()->autoIncrement()->notNull(),
			...
			'u_#__chat_rooms_crm' => [
				'columns' => [
					'roomid' => $this->integer(10)->unsigned()->autoIncrement()->notNull(),
					'userid' => $this->integer(10)->notNull(),
					'crmid' => $this->integer(10),
			...
			'u_#__fcorectinginvoice_inventory' => [
				...
				'primaryKeys' => [
					['fcorectinginvoice_inventory_pk', 'id']
				],
				'engine' => 'InnoDB',
				'charset' => 'utf8'
			],
			...
			'u_#__finvoiceproforma_inventory' => [
				...
				'primaryKeys' => [
					['finvoiceproforma_inventory_pk', 'id']
				],
				'engine' => 'InnoDB',
				'charset' => 'utf8'
			],
			...
			'u_#__servicecontracts_sla_policy' => [
				'columns' => [
					'id' => $this->integer()->autoIncrement()->notNull(),
				...
				'primaryKeys' => [
					['servicecontracts_sla_policy_pk', 'id']
				],
				'engine' => 'InnoDB',
				'charset' => 'utf8'
			],
			...
			'u_#__squoteenquiries_inventory' => [
				...
				'primaryKeys' => [
					['squoteenquiries_inventory_pk', 'id']
				],
				'engine' => 'InnoDB',
				'charset' => 'utf8'
			],
			...
			'u_#__srecurringorders_inventory' => [
				...
				'primaryKeys' => [
					['srecurringorders_inventory_pk', 'id']
				],
				'engine' => 'InnoDB',
				'charset' => 'utf8'
			],
			...
			'u_#__srequirementscards_inventory' => [
				...
				'primaryKeys' => [
					['srequirementscards_inventory_pk', 'id']
				],
				'engine' => 'InnoDB',
				'charset' => 'utf8'
			],
			...
			'u_#__svendorenquiries_inventory' => [
				...
				'primaryKeys' => [
					['svendorenquiries_inventory_pk', 'id']
				],
				'engine' => 'InnoDB',
				'charset' => 'utf8'
			],
